...
const SectionB = () => {
  return (
    <div className="relative bg-[#edefff] min-h-screen flex flex-col pt-16 pb-16">
      <img className="absolute -top-8 object-cover w-[100%]" src={bgImage} alt="section Image" />
        ...
        <div className="flex flex-col relative z-10 pt-8">
          ...
          <div className="flex space-x-10 flex-row items-center px-10  lg:px-28 pt-10">
            <div className="flex items-center gap-3 cursor-pointer w-[50%]">
                <img className="w-[50px] h-[50px] lg:w-[74px] lg:h-[74px]" src={explore} alt="explore more" />
                <p className="lg:text-[1.4rem] font-medium leading-[18px]">Explore More</p>
            </div>

            <div className="w-[50%] pl-[13px]">
                <p className="text-[#202229] font-bold lg:text-[1.4rem] leading-[32px]">30 more <span className="text-[#202229]/80 font-normal leading-[32px]">to explore</span></p>
            </div>
