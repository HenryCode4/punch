...
const SectionC = () => {
  return (
    <div className="relative bg-[#202229] min-h-screen flex flex-col pb-16">
      <img className="absolute top-0 left-0 right-0" src={curveup} alt="top curve" />
      <img
      ...
      <div className="text-white grid grid-cols-1 md:grid-cols-2 z-[99] pt-32 px-10  lg:px-28">
