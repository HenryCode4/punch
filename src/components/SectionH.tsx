      ...
      <div className="grid lg:grid-cols-3 px-10  lg:pl-28">
        <div className=" flex flex-col justify-center items-start">
          ...
          <p className="font-normal text-[0.9rem] md:text-[1.377rem] pt-6 pb-6 md:pt-0">
            ...
            <br /> processes - and simplify them.<br /> Connecting you to the world’s{" "}
        ...
        <div className="col-span-2 pl-6 py-4 rounded-lg bg-white shadow-lg">
            ...
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <p className="text-[0.8rem] md:text-[1.1rem] font-normal leading-[32px]">
            ...
            <div className="flex items-center gap-x-2 py-8">
                <img className='w-[40px] h-[40px]' src={join} alt="direction to learn more" />
                <p className='text-[0.8rem] md:text-[1.377rem] font-medium leading-[18px]'>Learn More</p>
            </div>
          ...
          <img className='object-cover h-[509px] hidden lg:block' src={riskImage} alt="risk image portray" />
            </div>
          
        </div>
      </div>

      <img className='absolute bottom-0 right-0 left-0 w-full' src={orangeCurve} alt="bottom curve" />
    </div>
  );
};
